...
- factor results、Market Score、CSV 匯出與正式排程的外部持久化服務（MVP 採 Supabase Free PostgreSQL，實作與驗證由 [Issue #18](https://github.com/TaylorYam/Huda-taiwan-market-quant/issues/18) 追蹤）。
