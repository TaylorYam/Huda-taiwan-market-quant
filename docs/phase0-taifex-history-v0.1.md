...
| Taiwan VIX | 免費每日收盤頁顯示 2026/06–09 月份；最新資料日為 2026-09-15。指數專區「3年」圖表實測窗口為 2023-09-16 至 2026-09-15。 | 未核實免費日收盤頁下載檔的精確首末筆與回應格式；三年圖表未驗證 CSV 匯出。付費歷史商品另列，不視為免費資料。 |
...
[TAIFEX 前 3 個月每日收盤 VIX 頁](https://www.taifex.com.tw/cht/7/vixDaily3MNew) 的免費頁面月份列表實測可見 2026/06、07、08、09，並確認最新資料日為 2026-09-15；欄位標示為交易日期及臺指選擇權波動率指數。此處只能確認頁面顯示當月與前三個月，月份內每日下載檔的精確首末筆、CSV 回應格式及最新數值尚未核實，不應寫成已完成 CSV 下載驗證。
...
3. VIX 免費日收盤頁可見下載按鈕及 `20260915(txt)` 檔名，但本次未取得下載內容，因此最新實際收盤值、檔案欄位及編碼尚未核實；三年圖表也未驗證可匯出。採用前需先確認檔案內容與收盤值欄位，不把 2020-11-23 新增的收盤前 1 分鐘平均值混作日收盤值。
