...
若目標是把展示網站的每日資料延伸到近五年（建議先抓 `2021-09-01` 至 `2026-09-30`，再依台股交易日篩選），目前真正的硬卡點只有兩項：
...
**最小需要範圍**：`2021-09-01` 至 `2023-09-24`。目前免費 rolling window 已涵蓋後段；若取得全段 `2021-09-01` 至 `2026-09-30`，驗證會更簡單。
...
**最小需要範圍**：`2021-09-01` 至 `2023-09-24`。若取得全段 `2021-09-01` 至 `2026-09-30`，可直接和現有資料做重疊比對。
