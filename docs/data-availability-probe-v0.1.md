...
| TX 行情（Basis） | TAIFEX | 官方年檔選單列 1998–2025；全檔稽核 28 份 ZIP，84,828 筆 TX 列、6,819 個年度日期、0 錯誤、0 重複鍵 | 2025 最新年度年檔（資料至 2025-12-31） | 日／分盤別 | 每年度 TX 日期都有正成交量列；1998–2016 無盤別，2017 起 schema 轉換，2018–2025 含一般／盤後 | 1998 年官方日曆缺漏未知；2026 年度檔尚未列出；價格與 Basis 仍需固定近月及轉倉規則 |
