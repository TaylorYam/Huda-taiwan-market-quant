...
| TX 年行情 ZIP | 官方年度下拉選單列 1998–2025；已全檔檢查 1998、2024、2025 三份 ZIP，1998 首末有效日期 1998-07-21–12-31、2024／2025 首末日分別為 2024-01-02–12-31、2025-01-02–12-31。 | 其餘 25 年未逐檔檢查；1998 年官方交易日曆缺漏仍未知。 |
| TXO PCR | 官方日期表單／CSV 已抽查上市前、上市首段、2025 休市週及最新區段；首個可取資料日 2001-12-24，最新樣本 2026-09-15。 | 起訖相差最多 30 個曆日（端點含在內），全期估計 292 段但尚未遍歷；完整缺漏率未知。 |
...
- **TXO PCR：**[官方查詢／CSV 頁](https://www.taifex.com.tw/cht/3/dlPcRatio) 的日期表單與下載端點已抽查上市前、上市初期、休市週及最新區段；首個可取資料日為 2001-12-24，最新樣本至 2026-09-15。起訖相差最多 30 個曆日且端點包含，每段最多 31 個曆日；完整回補估計 292 段，尚未遍歷。官方 [OpenAPI 文件](https://openapi.taifex.com.tw/) 的 `GET /PutCallRatio` 仍只是最新快照，不能替代歷史回補。
...
- **TX 年行情：**[每日行情／年度 ZIP 頁](https://www.taifex.com.tw/cht/3/dlFutDailyMarketView) 的年度選單列 1998–2025；已全檔檢查 1998、2024、2025 三份 ZIP。1998 首末 TX 日期為 1998-07-21–12-31，2024／2025 分別為 2024-01-02–12-31、2025-01-02–12-31；[TX 最後結算價頁](https://www.taifex.com.tw/cht/5/futIndxFSP) 的 1998-09 起始註記是另一資料口徑。其餘 25 年及 1998 官方交易日曆仍未驗證。
...
3. 若要完成 Issue #7，仍需遍歷 PCR 全期約 292 段、逐年檢查其餘 25 個 TX ZIP、取得 1998 官方交易日曆依據，並確認 VIX 日收盤 payload／值欄位與各付費檔授權、資料保存和 CI 使用權（如評估採購）。
