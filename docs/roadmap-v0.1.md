...
| 3 | [#9 決定 Phase 1 資料保存方案（ADR）](https://github.com/TaylorYam/Huda-taiwan-market-quant/issues/9) | 提交欄位／主鍵／時間語義／單位／修訂規則；審閱 [儲存方案比較](data-storage-options-v0.1.md)；先確認被 Git 忽略的 SQLite 作為本機開發預設，再於正式每日排程前選定持久化技術並新增 Accepted ADR | Issue 1–2 |
